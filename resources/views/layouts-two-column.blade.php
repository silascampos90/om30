                        ...
                        <table class="table table-nowrap table-centered align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('assets/images/users/avatar-1.jpg') }}" class="avatar-xxs rounded-circle me-1 shadow" alt="">
                                        ...
                                        <div class="avatar-group flex-nowrap">
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img src="{{ URL::asset('assets/images/users/avatar-1.jpg') }}" alt="" class="rounded-circle avatar-xxs shadow">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                            ...
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" alt="" class="rounded-circle avatar-xxs shadow">
                                                </a>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" class="avatar-xxs rounded-circle me-1 shadow" alt="">
                                    ...
                                    <td>
                                        <div class="avatar-group">
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}" alt="" class="rounded-circle avatar-xxs shadow">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="" class="rounded-circle avatar-xxs shadow">
                                                </a>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" class="avatar-xxs rounded-circle me-1 shadow" alt="">
                                    ...
                                    <td>
                                        <div class="avatar-group">
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img src="{{ URL::asset('assets/images/users/avatar-7.jpg') }}" alt="" class="rounded-circle avatar-xxs shadow">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img src="{{ URL::asset('assets/images/users/avatar-8.jpg') }}" alt="" class="rounded-circle avatar-xxs shadow">
                                                </a>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}" class="avatar-xxs rounded-circle me-1 shadow" alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" class="avatar-xxs rounded-circle me-1 shadow" alt="">
                                    ...
                                    <td>
                                        <div class="avatar-group">
                                            ...
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-xxs shadow">
                                                </a>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <div class="table-responsive table-card">
                        <table class="table table-borderless table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('assets/images/users/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-3 shadow me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-3 shadow me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('assets/images/users/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-3 shadow me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-3 shadow me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-3 shadow me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}" alt="" class="avatar-xs rounded-3 shadow me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-3 shadow me-2">
                                        <div>
                            ...
                            <li class="chat-list left">
                                <div class="conversation-list">
                                    <div class="chat-avatar">
                                        <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" alt="" class="shadow">
                                    </div>

                                ...
                                <div class="text-center mt-4 mb-5">
                                    <div class="py-3 px-2 d-inline-block" id="logo-tour">
                                        <img src="{{ URL::asset('assets/images/logo-dark.png') }}" class="card-logo card-logo-dark" alt="logo"
                                            height="17">
                                        <img src="{{ URL::asset('assets/images/om-teste.png') }}" class="card-logo card-logo-light" alt="logo"
                                            height="17">
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card border">
                                            <div class="card-body text-center">
                                                ...
                                                <h5>Free register</h5>
                                                <p class="text-muted mb-0">Get your Free Om30 Teste account now.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->
                                    <div class="col-lg-4">
                                        <div class="card border">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="text-muted mb-0">Sign in to continue to Om30 Teste.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->

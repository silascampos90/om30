                            ...
                            <div class="profile-user mx-auto  mb-3">
                                ...
                                <label for="profile-img-file-input" class="d-block" tabindex="0">
                                    <span class="overflow-hidden border border-dashed d-flex align-items-center justify-content-center rounded" style="height: 60px; width: 256px;">
                                        ...
                                        <img src="{{ URL::asset('assets/images/om-teste.png') }}" class="card-logo card-logo-light user-profile-image img-fluid" alt="logo light">
                                    </span>
                                </label>
                            </div>
                            <div>
                                    ...
                                    <td colspan="2" class="p-0">
                                        <table class="table table-borderless table-sm table-nowrap align-middle mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row">Discount <small class="text-muted">(Om30 Teste15)</small></th>
                                                    <td>

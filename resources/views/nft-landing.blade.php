        ...
        <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
            <div class="container">
                <a class="navbar-brand" href="index">
                    ...
                    <img src="{{URL::asset('assets/images/om-teste.png')}}" class="card-logo card-logo-light" alt="logo light" height="17">
                </a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 product-item artwork music games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="https://img.themesbrand.com/Om30 Teste/images/img-4.gif" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-lg-6">
                                                    ...
                                                    <img src="https://img.themesbrand.com/Om30 Teste/images/img-2.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-lg-6">
                                                    <img src="https://img.themesbrand.com/Om30 Teste/images/img-5.gif" alt="" class="img-fluid rounded mb-1">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-lg-6">
                                                    ...
                                                    <img src="https://img.themesbrand.com/Om30 Teste/images/img-1.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-lg-6">
                                                    <img src="https://img.themesbrand.com/Om30 Teste/images/img-4.gif" alt="" class="img-fluid rounded mb-1">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-lg-6">
                                                    ...
                                                    <img src="https://img.themesbrand.com/Om30 Teste/images/img-3.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-lg-6">
                                                    <img src="https://img.themesbrand.com/Om30 Teste/images/img-1.gif" alt="" class="img-fluid rounded mb-1">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-lg-6">
                                                    <img src="{{URL::asset('assets/images/nft/img-03.jpg')}}" alt="" class="img-fluid rounded">
                                                    <img src="https://img.themesbrand.com/Om30 Teste/images/img-5.gif" alt="" class="img-fluid rounded mt-1">
                                                </div>
                                                <!--end col-->
                                                <div class="col-lg-6">
                                                    <img src="https://img.themesbrand.com/Om30 Teste/images/img-2.gif" alt="" class="img-fluid rounded mb-1">
                                                    <img src="{{URL::asset('assets/images/nft/img-05.jpg')}}" alt="" class="img-fluid rounded">
                                                </div>
                                                <!--end col-->
                                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="https://img.themesbrand.com/Om30 Teste/images/img-1.gif" alt="" class="img-fluid explore-img">
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shink-0">
                                        <img src="https://img.themesbrand.com/Om30 Teste/images/img-5.gif" alt="" class="avatar-sm object-cover rounded">
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="pages-profile">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 mt-4">
                        <div>
                            <div>
                                <img src="{{URL::asset('assets/images/om-teste.png')}}" alt="logo light" height="17">
                            </div>
                            <div class="mt-4">
                                <p>Premium Multipurpose Admin & Dashboard Template</p>
                                <p>You can build any type of web application like eCommerce, CRM, CMS, Project management apps, Admin Panels, etc using Om30 Teste.</p>
                            </div>
                        </div>
                    </div>
